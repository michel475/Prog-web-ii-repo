...
const aluna = new Aluno("2030232", "Margaret Hamilton", "1214");
imprimirDadosTabela(aluna);
...
const novaPessoa = new Pessoa("Coisa 2", 15, "9999999");
imprimirDadosTabela(novaPessoa);
